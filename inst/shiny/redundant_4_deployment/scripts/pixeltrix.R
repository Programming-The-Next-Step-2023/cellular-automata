...
#'
#' This hidden function visualizes a matrix as a plot.
#'
#' @param m The matrix that you want to visualize.
#'
#' @param colours An optional vector of two colours for 0s and 1s in the
#'  matrix.
#'
#' @return The plot is drawn - so I guess this is what is "returned" by this
#'  function.
#'
#' @export
...
#'
#' @param input_matrix The matrix of the plot
#'
#' @param input_x X coordinate of where you clicked in the matrix plot.
#'
#' @param input_y Y coordinate of where you clicked in the matrix plot.
#'
#' @return Returns a list. First element is the row index of the matrix
